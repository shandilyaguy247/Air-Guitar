...
% delay in sec * samp/sec = samples
delayedSignal = [zeros(sampleDelay,1);in(1:end);zeros(64*fssampleDelay,1)];
...
while feedback >= 0.0001
%going to continually decrease feedback inside loop
